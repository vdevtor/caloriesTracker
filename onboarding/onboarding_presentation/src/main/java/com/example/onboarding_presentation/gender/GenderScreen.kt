...
fun GenderScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = com.vitorthemyth.core.R.string.whats_your_gender),
                style = MaterialTheme.typography.h3
            )
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            Row {
                SelectableButton(
                    text = stringResource(id = com.vitorthemyth.core.R.string.male),
                ...
                SelectableButton(
                    text = stringResource(id = com.vitorthemyth.core.R.string.female),
